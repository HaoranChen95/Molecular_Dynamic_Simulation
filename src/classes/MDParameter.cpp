...
MDParameter::MDParameter() {
  ...
  // N_ = lattice_edge_particles_ * lattice_edge_particles_ *
  // lattice_edge_particles_;
...
unsigned long MDParameter::lattice_edge_particles() const {
  return lattice_edge_particles_;
}
...
void MDParameter::read_input(const string& path, const string& suffix) {
  ...
  if (f_in.is_open()) {
        ...
        if (2 == line_cutted.size()) {  // to avoid empty value field
          ...
          if (!key.compare("lattice_edge_particles")) {
            ...
            N_ = lattice_edge_particles_ * lattice_edge_particles_ *
                 lattice_edge_particles_;
            boundary_width_ = lattice_edge_particles_ * lattice_constant_;
            cout << "set lattice_edge_particles\t" << lattice_edge_particles_
                 << endl;
            cout << "set N:\t\t\t\t" << N_ << endl;
            cout << "set boundary width:\t\t" << boundary_width_ << endl;
            cout << "===========================================" << endl;
    ...
    cout << "MDParameter::read_input: File could not be opened, path " << n
         << endl;
  }
